...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        body = json.dumps({
            ...
            "DROPBOX_REFRESH_TOKEN":  {"set": "DROPBOX_REFRESH_TOKEN" in os.environ, "len": len(os.environ.get("DROPBOX_REFRESH_TOKEN", "")), "preview": os.environ.get("DROPBOX_REFRESH_TOKEN", "")[:6] + "..." + os.environ.get("DROPBOX_REFRESH_TOKEN", "")[-4:]},
