    ...
    () => [
      {
        ...
        href: '/dashboard',
        lordSrc: 'https://cdn.lordicon.com/wmwqvixz.json',
      },
      {
        id: 'overview',
        label: 'Mi vehículo',
        icon: LayoutGrid,
        href: '/car',
        lordSrc: 'https://cdn.lordicon.com/hbtheitu.json',
      },
      {
        id: 'maintenance-group',
        label: 'Mantenimiento',
        icon: Wrench,
        lordSrc: 'https://cdn.lordicon.com/oaflahpk.json',
        children: [
          {
            id: 'maintenance',
            label: 'Mantenimiento',
          ...
          },
          {
            ...
            lordSrc: 'https://cdn.lordicon.com/abfverha.json',
          },
        ],
      },
      {
        ...
        label: 'Finanzas',
        icon: Wallet,
        lordSrc: 'https://cdn.lordicon.com/qhgmphtg.json',
        children: [
          {
            id: 'expenses',
            label: 'Gastos',
            icon: Receipt,
            href: '/expenses',
            lordSrc: 'https://cdn.lordicon.com/wloilxuq.json',
          },
          {
            id: 'insurance',
            label: 'Seguro',
            icon: ShieldCheck,
            href: '/insurance',
            lordSrc: 'https://cdn.lordicon.com/yvmiwkfe.json',
          },
        ],
      },
      {
        ...
        icon: Route,
        href: '/trips',
        lordSrc: 'https://cdn.lordicon.com/nqtddedc.json',
      },
      {
        id: 'obd2',
        label: 'OBD-II',
        icon: Cpu,
        href: '/obd2',
        lordSrc: 'https://cdn.lordicon.com/dxjqoygy.json',
      },
      {
        id: 'mechanics',
        label: 'Talleres',
        icon: Store,
        href: '/mechanics',
        lordSrc: 'https://cdn.lordicon.com/rbbnmpcf.json',
      },
      {
        id: 'management-group',
        label: 'Gestión',
        icon: Folder,
        lordSrc: 'https://cdn.lordicon.com/ndydpcaq.json',
        children: [
          {
            id: 'documents',
            label: 'Documentos',
            icon: FileText,
            href: '/documents',
            lordSrc: 'https://cdn.lordicon.com/nbqnnxoy.json',
          },
          {
            id: 'sharing',
            label: 'Compartir',
            icon: Share2,
            href: '/sharing',
            lordSrc: 'https://cdn.lordicon.com/tljgagqf.json',
          },
        ],
      },
      {
        ...
        icon: Settings,
        href: '/settings',
        lordSrc: 'https://cdn.lordicon.com/hwjcdnil.json',
      },
    ],
    [],
  );
