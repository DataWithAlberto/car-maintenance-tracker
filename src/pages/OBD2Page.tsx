...
export const OBD2Page = () => {
  ...
  const handleToggleRecording = () => {
    ...
    toast.success(isRecording ? 'Grabación desactivada' : 'Grabación activada');
  };
  ...
  const handleImportKm = async () => {
    ...
    if (!km) {
      toast.error('Odómetro no disponible en este vehículo');
      return;
    }
  ...
  return (
    <div className="px-6 sm:px-10 py-10 space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p
                ...
                style={{ fontSize: 15, lineHeight: 1.45 }}
              >
                Web Bluetooth requiere <strong>Chrome</strong> o <strong>Edge</strong> en Android,
                macOS o Windows. No funciona en Safari, Firefox ni iOS.
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="bg-snow border border-silver-mist rounded-[28px] p-7">
        <h2
          className="font-mono uppercase text-graphite mb-5"
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              <p
                className="font-display text-ink"
                style={{ fontWeight: 600, fontSize: 18, letterSpacing: '-0.2px' }}
              >
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Button
                ...
                iconLeft={<HardDrive className="h-3.5 w-3.5" strokeWidth={1.7} />}
              >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="bg-fog rounded-[20px] p-5">
              <div className="flex items-center gap-2 mb-2">
                <span
                  ...
                  style={{ width: 6, height: 6, background: '#0071e3' }}
                />
                <span
                  className="font-mono uppercase text-graphite"
              ...
              <p className="font-text text-graphite mt-0.5" style={{ fontSize: 12 }}>
                rev/min
              </p>
            ...
            <div className="bg-fog rounded-[20px] p-5">
              <div className="flex items-center gap-2 mb-2">
                <span
                  className="rounded-full"
                  style={{ width: 6, height: 6, background: '#1a9e3f' }}
                />
                <span
                  className="font-mono uppercase text-graphite"
                  style={{ fontSize: 10, letterSpacing: '0.12em' }}
              ...
              {liveData.speed != null && (
                <GaugeBar value={liveData.speed} max={250} color="#1a9e3f" />
              )}
            </div>
              ...
              <div className="flex items-center gap-2 mb-2">
                <span
                  ...
                  style={{
                    ...
                    height: 6,
                    background:
                      liveData.coolantTemp != null && liveData.coolantTemp > 110
                        ? '#d70015'
                        : '#c77700',
                  }}
                />
              ...
              <div className="flex items-center gap-2 mb-2">
                <span
                  ...
                  style={{
                    ...
                    height: 6,
                    background:
                      liveData.fuelLevel != null && liveData.fuelLevel < 15 ? '#d70015' : '#b64400',
                  }}
                />
                <span
                  className="font-mono uppercase text-graphite"
          ...
          {vinLoaded &&
            (vin ? (
              <div className="bg-fog rounded-[18px] px-5 py-4 space-y-3">
                <p className="font-mono text-ink" style={{ fontSize: 18, letterSpacing: '0.08em' }}>
                  {vin}
                </p>
                <div className="flex items-center gap-3 flex-wrap">
                  <Button
            ...
            <div>
              ...
              {dtcsLoaded && (
                <p className="font-text text-graphite mt-1" style={{ fontSize: 13 }}>
                  {dtcs.length === 0
                    ? 'Sin errores activos'
                    : `${dtcs.length} código${dtcs.length > 1 ? 's' : ''} activo${dtcs.length > 1 ? 's' : ''}`}
                </p>
              )}
            </div>
            <div className="flex items-center gap-2 flex-wrap">
              {dtcsLoaded && dtcs.length > 0 && (
                <Button
                  ...
                  iconLeft={
                    !clearLoading ? <Trash2 className="h-3.5 w-3.5" strokeWidth={1.7} /> : undefined
                  }
                >
                  Borrar códigos
                </Button>
              ...
              <Button
                ...
                iconLeft={
                  !dtcLoading ? <RefreshCw className="h-3.5 w-3.5" strokeWidth={1.7} /> : undefined
                }
              >
                Leer errores
              </Button>
              ...
              {dtcs.map((dtc) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      background: isCritical ? '#fce8e0' : 'var(--color-fog)',
                      border: `1px solid ${isCritical ? '#f5c6b0' : 'var(--color-silver-mist)'}`,
                    }}
                  >
                    ...
                    <p
                      className="font-text text-ink flex-1"
