...
import type { CreateTripInput, CreateTripBookingInput } from '../types';
...
export const TripsPage = () => {
  ...
  const handleCreateBooking = async (data: CreateTripBookingInput) => {
    ...
    await createBooking(user.id, data);
          ...
          >
            <div className="flex items-center justify-between flex-wrap" style={{ gap: 12 }}>
              ...
              <div className="flex items-center" style={{ gap: 6 }}>
                <span
                  className="font-mono uppercase"
                  style={{ fontSize: 10, letterSpacing: '.18em', color: '#a1a1a6', marginRight: 2 }}
                >
                  Filtros
                </span>
